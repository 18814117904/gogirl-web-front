$(function () {
    ...
    function c() {
        ...
        if (k) {
            var p = '<a href="' + o + '" class="active J_menuTab router-link-active" data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
            // var p ="<a href=\"#/\" class=\"J_menuTab router-link-active\" data-id=\"\">首页</a>";
