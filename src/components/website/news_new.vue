      ...
      <el-form :model="news" :rules="rules" ref="news" label-width="100px">
        <div style="margin-bottom: 5px ">
          <div class="fixed-table-container bootstrap-table">
            <h3 style="margin-top:20px;">创建活动</h3>
            <table class="table table-hover">
              ...
              <tr>
                <td colspan="2">
                  <span style="color: rgb(255, 0, 0);">活动详情</span>
                </td>
              </tr>
              <tr>
                <td colspan="2">
                  <UEditor :config=config2 ref="ueditor" v-model="news.content"></UEditor>
                </td>
              </tr>
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        ajax.open('post',this.$BASE_PATH + 'websiteNews/insert',true);
