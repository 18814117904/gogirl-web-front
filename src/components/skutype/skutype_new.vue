  ...
  <div>
    ...
    align-items: center;">
        ...
        <el-form-itam>
          ...
          <el-button type="primary" plain @click="save" style="margin-top: 18px" v-bind:disabled="hadSave">保存</el-button>
        </el-form-itam>
      </el-form>
      ...
      save() {
        this.$refs.skutype.validate(valid => {
          if(valid){
            ...
            searchAxios.post(this.$BASE_PURCHASE_URL + 'skuType/insert', postData)
              .then(function (response) {
                this.$layer.msg(response.data.message)
                this.$emit('addChildClick')
              }.bind(this))
          }else {
            return false
          }
