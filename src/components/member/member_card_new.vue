          ...
          <div class="fixed-table-container bootstrap-table">
            ...
            <table class="table table-hover">
              ...
              <tr>
                ...
                <span>
              <el-input placeholder="请输入用户名" required v-model="memberCard.name" style="max-width:100%;"></el-input>
            </span>
                  </el-form-item>
                </td>
                <td>
                ...
                <span>
                  <el-input placeholder="请输入 电话号码" v-model="memberCard.phone" style="max-width:100%;"></el-input>
                </span>
                  </el-form-item>
                </td>
              </tr>
    ...
    data: function(){
      ...
      return {
        ...
        rules: {
          ...
          amount: [{validator: newReg1, trigger: 'blur'}],
      ...
      save() {
        this.$refs.memberCard.validate(valid => {
          if (valid) {
            ...
            searchAxios.post(this.$BASE_USER_URL + 'newCustomerCard', postData)
